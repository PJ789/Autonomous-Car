...
- Use an analogue servo (or digital servo if you prefer) to control steering. If your RC car donor doesn't have a servo for steering (mine PoS has a DC motor), you should make it so. I will do that at some point. Controlling a servo is far easier than trying to control a DC motor, and gives you much better control. I wish I'd done that. NB the turret is best controlled by a digital servo; ideally you at least want accurate turret positioning if not steering.
