...
Radar::Radar():front_ultrasound(FRONT_ULTRASOUND_TRIG_PIN,FRONT_ULTRASOUND_ECHO_PIN),rear_ultrasound(REAR_ULTRASOUND_TRIG_PIN,REAR_ULTRASOUND_ECHO_PIN),radar_turret(RADAR_TURRET_PIN)
{
